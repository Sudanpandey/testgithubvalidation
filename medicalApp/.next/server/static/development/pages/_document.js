...
var _jsxFileName = "/home/lewin/medicalApp/pages/_document.js";
...
class Document extends next_document__WEBPACK_IMPORTED_MODULE_1___default.a {
  static async getInitialProps(ctx) {
    const materialUiSheets = new _material_ui_styles__WEBPACK_IMPORTED_MODULE_2__["ServerStyleSheets"]();
    const originalRenderPage = ctx.renderPage;

    try {
      ctx.renderPage = () => originalRenderPage({
        enhanceApp: App => props => materialUiSheets.collect(__jsx(App, _extends({}, props, {
          __self: this,
          __source: {
      ...
      return _objectSpread({}, initialProps, {
        ...
        }, initialProps.styles, materialUiSheets.getStyleElement())]
      });
    } finally {}
  }
