...
var formValidationSchema = yup__WEBPACK_IMPORTED_MODULE_5__["object"]().shape(Object(_babel_runtime_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_0__["default"])({
  fname: yup__WEBPACK_IMPORTED_MODULE_5__["string"]().min(2, "Too Short!").max(25, "Too Long!").required("First NAme is required"),
  lname: yup__WEBPACK_IMPORTED_MODULE_5__["string"]().min(2, "Too Short!").max(25, "Too Long!").min(6, "Password has to be longer than 6 characters!").required("Last name is required"),
  email: yup__WEBPACK_IMPORTED_MODULE_5__["string"]().min(2, "Too Short!").max(25, "Too Long!").min(6, "Password has to be longer than 6 characters!").required("Email  is required"),
  password: yup__WEBPACK_IMPORTED_MODULE_5__["string"]().min(2, "Too Short!").max(25, "Too Long!").min(6, "Password has to be longer than 6 characters!").required("Valid password  is required")
...
//# sourceMappingURL=index.js.5d00f9c70cdf6a840cfe.hot-update.js.map